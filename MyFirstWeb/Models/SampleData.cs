...
namespace MyFirstWeb.Models
{
    ...
    {
        public MusicStoreEntities Seed()
        {
            ...
            MusicStoreEntities ms = new MusicStoreEntities();
            int id = 1;
            foreach (Album ab in album )
            {
                ab.AlbumId = id;
                id++;
                ms.GetAlbums().Add(ab);
            ...
            foreach (Genre gen in genres)
            {
                gen.GenreId = id;
                id++;
                ms.GetGenres().Add(gen);
            }
            return ms;
        }
        public List<Artist> GetArtists()
        {
            var listRes = new List<Artist>
            {
                new Artist { Name = "Aaron Copland & London Symphony Orchestra" },
                new Artist { Name = "Aaron Goldberg" },
                new Artist { Name = "AC/DC" },
